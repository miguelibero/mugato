...
namespace mugato {
    ...
    const SpriteAtlas::RegionMap& SpriteAtlas::getRegions() const
    {
        return _regions;
    }

    const SpriteAtlas::Regions& SpriteAtlas::getRegions(
    ...
    const SpriteAtlas::Region& SpriteAtlas::getRegion(
